...
balance_gain = 50.0          # Proportional gain on roll angle
velocity_gain = 0.0         # Derivative gain on roll rate (INCREASED!)
wheel_speed_gain = 50.0      # How aggressively to apply wheel velocity
